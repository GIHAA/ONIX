...
const Attendance = () => {
    ...
    const onDelete = (id) => {
        axios.delete(`http://localhost:8080/api/attendance/${id}`).then((res) => {
        ...
        <div className=" flex-[85%]">
          ...
          >
            <div className=" w-full h-full bg-white shadow-lg rounded-xl">
                ...
                <h1 className="text-[30px] font-semibold ml-[150px] mt-5">Attendance </h1>
  ...
  {filteredData.map((item) => {
                        return(
                          ...
                          <tr className="hover:bg-[#efeeee] border-[2px]">
                            ...
                            <td className="p-3 w-[350px]">{moment(item.date).format('MMMM Do, YYYY h:mm a')}</td>
