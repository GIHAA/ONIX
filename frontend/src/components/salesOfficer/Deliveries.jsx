                        ...
                        return(
                          ...
                          <td className="p-3 w-[150px]">{item.orderid}</td>
                            ...
                            <div className="flex ml-12">
                                <button onClick={() => {setFormData({...item , no}); setShowEditModal(true); setId(item._id);}} className=" items-center px-5 py-1 mr-5 bg-[#2E4960] w-[100px] text-white font-semibold hover:bg-[#1b3348] rounded-xl">
                                  <span
                                  className="flex">
...
<input  id="location" name="location" value="instore" onChange={onChange} type="text" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
